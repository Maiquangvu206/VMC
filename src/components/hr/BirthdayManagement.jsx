  ...
  return (
    <div className="space-y-6">
      ...
      {birthdayAssignments.map(a => {
        ...
        const formattedDeadline = `${String(monitoringDeadlineDate.getDate()).padStart(2, '0')}/${String(monitoringDeadlineDate.getMonth()).padStart(2, '0')}/${monitoringDeadlineDate.getFullYear()}`;
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 space-y-1.5">
                          <label className={`ds-btn ds-btn-ghost w-full text-center ${cfg.cardUploading ? 'opacity-50 cursor-not-allowed' : ''
                            }`}>
            ...
            <form onSubmit={handleConfirmMemberSubmit} className="space-y-4 text-xs">
              ...
              <div className="flex gap-2 p-1 bg-[var(--bg-primary)] rounded-xl border border-[var(--border-default)]">
                <button
                  ...
                  className={`flex-1 py-1.5 rounded-lg text-center font-bold transition-all ${submissionMethod === 'upload' ? 'bg-pink-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                >
                  Tải Ảnh Lên
                </button>
                <button
                  ...
                  className={`flex-1 py-1.5 rounded-lg text-center font-bold transition-all ${submissionMethod === 'link' ? 'bg-pink-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                >
                  Dán Link
                </button>
                <button
                  ...
                  className={`flex-1 py-1.5 rounded-lg text-center font-bold transition-all ${submissionMethod === 'no_photo' ? 'bg-pink-600 text-white' : 'text-slate-400 hover:text-slate-200'
                    }`}
                >
                  Không Có Ảnh
                </button>
