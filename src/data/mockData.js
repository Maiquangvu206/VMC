...
// Accounts with full 10 member info fields + Term / Generation (Thời Kỳ / Nhiệm Kỳ):
export const MEMBER_ACCOUNTS = [
  // Nhiệm kỳ 2025 - 2026 (Khóa 25 - Đương Nhiệm)
  {
    id: "vmc-admin-01",
    memberCode: "ADMIN",
    username: "admin",
    ...
    dob: "15/08/2008",
    address: "Khu 3, Thị trấn Vĩnh Bảo, Huyện Vĩnh Bảo, Hải Phòng",
  ...
  },
  {
    ...
    dob: "20/11/2009",
    address: "Xã Tân Liên, Huyện Vĩnh Bảo, Hải Phòng",
  ...
  },
  {
    ...
    dob: "05/03/2008",
    address: "Xã Tam Cường, Huyện Vĩnh Bảo, Hải Phòng",
  ...
  },
  {
    ...
    class: "10A1",
    role: "member",
    roleTitle: "Phó Ban Truyền Thông",
    department: "pr",
    ...
    dob: "18/09/2010",
    address: "Xã Tiền Phong, Huyện Vĩnh Bảo, Hải Phòng",
    facebook: "https://facebook.com/linhchi.vmc",
    points: 620,
    status: "Active"
  },

  // Nhiệm kỳ 2024 - 2025 (Cựu Thành Viên Khóa 24)
  {
    id: "vmc-old-2401",
    ...
    isFirstLogin: false,
    name: "Nguyễn Anh Tú",
    class: "Cựu 12A1 (Niên khóa 2022-2025)",
    role: "alumni",
    roleTitle: "Cựu Chủ Nhiệm CLB (Gen 4)",
    department: "bcn",
    deptName: "Ban Chủ Nhiệm",
    term: "2024-2025",
    termName: "Nhiệm Kỳ 2024 - 2025",
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=400",
    phone: "0915 222 333",
    email: "anhtu.k24@gmail.com",
    dob: "10/02/2007",
    address: "Thị trấn Vĩnh Bảo, Hải Phòng",
  ...
  },
  {
    ...
    isFirstLogin: false,
    name: "Trần Thu Huyền",
    class: "Cựu 12A3 (Niên khóa 2022-2025)",
    role: "alumni",
    roleTitle: "Cựu Trưởng Ban Sản Xuất",
    department: "production",
    deptName: "Ban Sản Xuất",
    term: "2024-2025",
    termName: "Nhiệm Kỳ 2024 - 2025",
    ...
    dob: "25/06/2007",
    address: "Xã Nhân Hòa, Vĩnh Bảo, Hải Phòng",
    facebook: "https://facebook.com/thuhuyen.vbc",
    points: 2800,
    status: "Active"
  },

  // Nhiệm kỳ 2023 - 2024 (Khóa 23)
  {
    id: "vmc-old-2301",
    ...
    isFirstLogin: false,
    name: "Lê Hoàng Duy",
    class: "Cựu 12A1 (Niên khóa 2021-2024)",
    role: "alumni",
    roleTitle: "Cựu Chủ Nhiệm CLB (Gen 3)",
    department: "bcn",
    deptName: "Ban Chủ Nhiệm",
    term: "2023-2024",
    termName: "Nhiệm Kỳ 2023 - 2024",
  ...
  // Nhiệm kỳ 2022 - 2023 (Khóa 22 - Khóa Sáng Lập)
  {
    id: "vmc-old-2201",
    ...
    class: "Cựu 12A1 (Niên khóa 2020-2023)",
    role: "alumni",
    roleTitle: "Trưởng Ban Sáng Lập CLB VMC (Gen 1)",
    department: "bcn",
    deptName: "Ban Chủ Nhiệm",
    term: "2022-2023",
    termName: "Nhiệm Kỳ 2022 - 2023 (Khóa Sáng Lập)",
